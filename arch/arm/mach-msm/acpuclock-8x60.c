...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	[0]  = { MAX_AXI, 0, 0,    1000000, 1000000, 0},
	[1]  = { 432000,  1, 0x08,  950000, 1000000, 0},
	[2]  = { 540000,  1, 0x0A, 1000000, 1000000, 1},
	[3]  = { 648000,  1, 0x0C, 1000000, 1050000, 1},
	[4]  = { 756000,  1, 0x0E, 1050000, 1050000, 1},
	[5]  = { 864000,  1, 0x10, 1050000, 1100000, 1},
	[6]  = { 972000,  1, 0x12, 1100000, 1100000, 2},
	[7]  = {1080000,  1, 0x14, 1100000, 1150000, 2},
	[8]  = {1188000,  1, 0x16, 1150000, 1150000, 2},
	[9]  = {1296000,  1, 0x18, 1150000, 1200000, 3},
	[10] = {1404000,  1, 0x1A, 1200000, 1200000, 3},
...
static struct clkctl_acpu_speed acpu_freq_tbl_v2[] = {
  ...
  { {1, 1},  540000,  ACPU_SCPLL, 0, 0, 1, 0x0A, L2(2),   875000, 0x03006000},
  { {1, 1},  648000,  ACPU_SCPLL, 0, 0, 1, 0x0C, L2(3),   900000, 0x03006000},
  { {1, 1},  756000,  ACPU_SCPLL, 0, 0, 1, 0x0E, L2(4),   925000, 0x03006000},
  { {1, 1},  864000,  ACPU_SCPLL, 0, 0, 1, 0x10, L2(5),   950000, 0x03006000},
  { {1, 1},  972000,  ACPU_SCPLL, 0, 0, 1, 0x12, L2(6),   975000, 0x03006000},
  { {1, 1}, 1080000,  ACPU_SCPLL, 0, 0, 1, 0x14, L2(7),  1025000, 0x03006000},
  { {1, 1}, 1188000,  ACPU_SCPLL, 0, 0, 1, 0x16, L2(8),  1075000, 0x03006000},
  { {1, 1}, 1296000,  ACPU_SCPLL, 0, 0, 1, 0x18, L2(9),  1125000, 0x03006000},
  { {1, 1}, 1404000,  ACPU_SCPLL, 0, 0, 1, 0x1A, L2(10), 1175000, 0x03006000},
...
static void __init scpll_init(int sc_pll)
{
	...
	writel_relaxed(SCPLL_DEBUG_FULL, sc_pll_base[sc_pll] + SCPLL_DEBUG_OFFSET);
	writel_relaxed(0x0, sc_pll_base[sc_pll] + SCPLL_LUT_A_HW_MAX);
	writel_relaxed(SCPLL_DEBUG_NONE, sc_pll_base[sc_pll] + SCPLL_DEBUG_OFFSET);
